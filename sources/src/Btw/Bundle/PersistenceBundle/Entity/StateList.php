...
/**
 * The link between {@link Party} and {@link State}. All parties have to explicitly run for seats in each state. It is
 * also possibly to only contest in one single state (e.g. CSU in Bayern). For more information about candidates, see
 * {@link StateCandidacy}.
 *
